...
- Settings → Web login: create users, enable login, log in; change a password with the pencil icon on the right of the user row (no extra section); deleting the last user confirms and turns auth off.
